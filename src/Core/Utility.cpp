...
// Bit weird this way of doing random but maybe C++ wasn't that advanced back then
namespace
{
...
std::string toString(sf::Keyboard::Key key) {
    // Genuinely this is an abomination
	// But I have no idea how else to do it in a more concise way
...
// idk why the book did not just use PI
